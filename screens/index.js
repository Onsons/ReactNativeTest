...
export const ReporteScreen= ({navigation}) => <Screen navigation= {navigation} name="Report"/>
export const StatisticeScreen= ({navigation}) => <Screen navigation= {navigation} name="Statistic"/>
